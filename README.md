...
Bu repository, FinTechBankX DDD/EDA dönüşümünde **svc-of-banking-metadata** servis yetkinliğinin kaynak kodunu, kontratlarını ve operasyonel guardrail'lerini içerir.
...
| Bounded Context | banking_metadata |
| Wave | 2 |
...
## Kapsam
### In Scope
- banking_metadata bağlamına ait uygulama kodu, testler ve otomasyon.
