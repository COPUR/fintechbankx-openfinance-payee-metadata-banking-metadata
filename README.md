...
- **Squad:** Payee & Metadata Squad
- **Repo Kümesi:** `openfinance-verification`
- **Bounded Context:** `open-finance`
- **Ana Capability:** Banking metadata enrichment services
- **Dönüşüm Wave:** 2
...
- `Banking metadata enrichment services` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
